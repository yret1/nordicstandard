...
const Reach = () => {
  return (
    <section className="w-screen flex flex-col gap-6 justify-center items-center">
      ...
      <section className="w-11/12 place-items-center gap-8 p-6 order-2 md:order-1 justify-items-center md:p-6 md:w-10/12 lg:w-8/12 grid grid-cols-1 grid-rows-2 md:grid-rows-1 md:grid-cols-2">
        <GridContent
